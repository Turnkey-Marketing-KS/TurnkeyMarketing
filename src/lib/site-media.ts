...
export const siteMedia = {
  ...
  graphics: {
    ...
    directMailMailbox: {
      src: "/images/services/direct-mail-mailbox.webp",
    ...
    serviceDirectTrack: {
      src: "/images/services/directtrack-marketing-hero-v2.webp",
      alt: "Tactile location-target sculpture representing DirectTrack Marketing",
      position: "50% 50%",
    },
    serviceConsulting: {
      src: "/images/services/marketing-consulting-hero-v2.webp",
      alt: "Tactile compass sculpture representing marketing consulting",
      position: "50% 50%",
    },
    serviceSocial: {
      src: "/images/services/social-media-marketing-hero-v2.webp",
      alt: "Tactile message-board sculpture representing social media marketing",
      position: "50% 50%",
    },
    serviceRetention: {
      src: "/images/services/retention-marketing-hero-v2.webp",
      alt: "Tactile return-arrow and envelope sculpture representing retention marketing",
      position: "50% 50%",
    },
    serviceDigital: {
      src: "/images/services/digital-marketing-hero-v2.webp",
      alt: "Tactile auto-shop visibility sculpture representing digital marketing",
      position: "50% 50%",
    },
    serviceBoostDays: {
      src: "/images/services/boost-days-hero-v2.webp",
      alt: "Tactile calendar and lightning sculpture representing Boost Days",
      position: "50% 50%",
    },
    problems: {
