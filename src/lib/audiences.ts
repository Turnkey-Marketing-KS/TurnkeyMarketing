...
export const audiences: AudiencePage[] = [
  ...
  },
  {
    ...
    heroCopy:
      "A second location does not just double the marketing workload. Each shop has its own capacity, local demand, reviews, profile, team, and performance. The ownership group still needs one brand and a clear plan for every location.",
    image: {
